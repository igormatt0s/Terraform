# Criação de VM na AWS com user-data

## Contexto

Este repositório foi criado como conteúdo adicional para a aula [**Criação de VM na AWS com user-data**](https://www.udemy.com/course/terraform-do-basico-ao-avancado/learn/lecture/40339274#overview) do curso [**Terraform - Básico ao Avançado**](https://www.udemy.com/course/terraform-do-basico-ao-avancado/?couponCode=TERRAFORM_OUT23), por Daniel Gil.
